...
def objective(trial):
    ...
    metric = trial.suggest_categorical("metric", ['euclidean'])#, 'hamming', 'jaccard', 'manhattan'])
    ...
    clusterer = DocumentClusterer(min_cluster_size=min_cluster_size, max_cluster_size=max_cluster_size, min_samples=min_samples, cluster_selection_method=cluster_selection_method, metric=metric)
...
if __name__ == "__main__":
    ...
    clusterer = DocumentClusterer(min_cluster_size=best_min_cluster_size, max_cluster_size=best_max_cluster_size,
                                  min_samples=best_min_samples, cluster_selection_method=best_cluster_selection_method,
                                  metric=best_metric)
